...
MUTANTS = [
    ("stick y drawn inverted", "web/index.html",
     "const dy = -sy * TRAVEL_Y;", "const dy = sy * TRAVEL_Y;", "blackbox_render", "sticks"),
    ("stick x drawn inverted", "web/index.html",
     "const x = g.cx + sx * TRAVEL_X", "const x = g.cx - sx * TRAVEL_X", "blackbox_render", "sticks"),
    ("gimbal slot doesn't move with the stick", "web/index.html",
     "part.setAttribute(\"transform\", `translate(0 ${dy.toFixed(2)})`)",
     "part.setAttribute(\"transform\", \"\")", "blackbox_render", "sticks"),
    ("stick moves radially (knob leaves the slot)", "web/index.html",
     "const x = g.cx + sx * TRAVEL_X, y = g.cy + dy;",
     "const x = g.cx + sx * TRAVEL_X * 1.6, y = g.cy + dy;", "blackbox_render", "sticks"),
