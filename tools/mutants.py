...
MUTANTS = [
    ...
    ("wizard refuses on/off channels for SB, SC, S1 and sticks", "src/learn.rs",
     "if target.prefers_analog() && best", "if false && best", "blackbox_ws", "wizard_takes_on_off"),
    ("wizard doesn't prefer CH1-8 when a switch is on both kinds", "src/learn.rs",
     "self.busiest(|ch| !target.prefers_analog() || ch <= axes)", "self.busiest(|_| true)",
     "blackbox_ws", "both_kinds"),
    ...
    ("setup page flags SB on CH9-32 as a mistake", "web/index.html",
     "const odd = !onOff && want", "const odd = want", "blackbox_render", "on_off_instead"),
