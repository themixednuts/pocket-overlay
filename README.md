...
- **Change the look** on the setup page (<http://127.0.0.1:7878/?setup=1>), under **Look**. OBS updates as you go.
  - **Accent:** pick a preset or any colour. **Reset** puts the green back.
  - **Just the controller:** turn off **Readout** and **Channel bars**. The top of the setup page shows the OBS size to use (680 × 660 with both off).
